...
function getFilteredServices() {
	...
	foreach ($services as $service) {
		...
		echo 			"<img class='cardArrow' src='http://localhost/helsinki/wp-content/themes/newco_helsinki/Icons/keyboard_arrow_right-24px.svg' alt='placeholder icon'>";
		echo 		"</a>";
		echo 	"</div>";
		echo "</div>";
	}
            ...
            echo "<div class='newsText'>";
                ...
                echo "<div class='readMore'>";
                    echo "<a href='" . get_the_permalink($article->ID) . "' class='dropbtn'>Lue lisää";
                        echo "<img class='cardArrow' src='http://localhost/helsinki/wp-content/uploads/2020/04/category-24px.svg' alt='placeholder icon'>";
                    echo "</a>";
               echo " </div>";
           echo " </div>";
        echo "</div>";
